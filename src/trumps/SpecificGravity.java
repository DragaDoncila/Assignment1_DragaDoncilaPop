...
/**
 * Class handles Trumps.Trump objects of the Specific Gravity category. Provides methods for parsing
 * string to appropriate value type for comparison, as well as methods for comparison and display.
