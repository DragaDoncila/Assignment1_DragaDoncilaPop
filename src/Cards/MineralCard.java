...
/**
 * Class extends abstract Card and implements all fields and methods required for a Mineral Supertrumps Mineral card
...
//        Mineral Card cannot be the Geologist
    ...
    /**
     * Checks whether the value associated with the current trump category of this card, is higher than that
     * of the last played card.
     *
